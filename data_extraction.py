...
# ------------------------------
# POPPLER PATH (update for your machine)
# ------------------------------
POPPLER_PATH = r"C:\Users\Administrator\Downloads\Release-25.07.0-0\poppler-25.07.0\Library\bin"
...
with right:
    ...
    if st.button("Ask"):
        if not st.session_state.get("text_blocks"):
            ...
            # IMPROVED PROMPT
            prompt = f"""
You are an expert document analyst. Use the context from the uploaded document to provide a precise, concise, and accurate answer. 
If the information is not available in the document, respond with 'Information not found in the document.' 
...
Answer in a clear and concise manner, using bullet points if multiple items are relevant.
"""
